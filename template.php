<?php
// $Id: template.php,v 1.1.2.2 2008/10/18 00:35:36 jwolf Exp $
    ...
    switch (theme_get_setting('front_page_title_display')) {
      ...
      case 'custom':
        if (theme_get_setting('page_title_display_custom') !== '') {
          $vars['head_title'] = drupal_set_title(theme_get_setting('page_title_display_custom'));
          break;
        }
        break;
    }
    ...
    switch (theme_get_setting('other_page_title_display')) {
      ...
      case 'ptitle_custom':
        if (theme_get_setting('other_page_title_display_custom') !== '') {
          $vars['head_title'] = drupal_set_title($page_title . $title_separator . theme_get_setting('other_page_title_display_custom'));
          break;
        }
        break;
      case 'custom':
        if (theme_get_setting('other_page_title_display_custom') !== '') {
          $vars['head_title'] = drupal_set_title(theme_get_setting('other_page_title_display_custom'));
          break;
        }
    }
  }
...
function phptemplate_preprocess_node(&$vars) {
  ...
  $vars['template_files'] = array('node-default-page', 'node-'. $vars['node']->type, 'node-'. $vars['node']->nid .'-page');
